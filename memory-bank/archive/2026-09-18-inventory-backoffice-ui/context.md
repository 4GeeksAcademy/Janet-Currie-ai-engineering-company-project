...
Milestone 5 Part 2: authenticated backoffice inventory views in `uis/web`, talking only to the Part 1 `/inventory` API. Phase guide: [`Backoffice-Inventory-Interface-Context.md`](Backoffice-Inventory-Interface-Context.md).
...
| Path | Role |
|------|------|
| `Backoffice-Inventory-Interface-Context.md` | Part 2 phase guide (this archive) |
