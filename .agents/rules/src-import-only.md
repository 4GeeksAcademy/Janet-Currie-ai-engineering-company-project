...
2. UI apps (`uis/backoffice`, `uis/website`, demos) must **import** these modules. Do not copy formulas, types, or sample data into app folders.
3. Do not edit thresholds, validators, or transforms unless the user explicitly requests a logic change.
4. Prefer path alias `@healthcore/*` or relative `../../src/...` imports from `uis/backoffice`.
